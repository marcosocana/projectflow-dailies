...
create policy if not exists "Public read for project logos"
on storage.objects
for select
using (bucket_id = 'project-logos');

create policy if not exists "Authenticated upload project logos"
on storage.objects
for insert to authenticated
with check (bucket_id = 'project-logos');

create policy if not exists "Authenticated update project logos"
on storage.objects
for update to authenticated
using (bucket_id = 'project-logos');

create policy if not exists "Authenticated delete project logos"
on storage.objects
...
create policy if not exists "Anyone can view incident comments"
