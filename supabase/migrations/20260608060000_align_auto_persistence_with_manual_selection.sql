-- Align the 06:00 automatic daily persistence with the manual Persistir modal:
-- carry everything forward except tasks whose effective status is Resuelta - En PRO.
